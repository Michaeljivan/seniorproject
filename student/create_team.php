...
<head>
	...
	<header class="w3-bar w3-border w3-light-grey">
		...
		<a href="create_team.php" class="w3-bar-item w3-button w3-blue">Create Your Team!</a>
		...
		<form action="team_insert.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
			...
			<div class="w3-row w3-section">
			  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-clone"></i></div>
			    <div class="w3-rest">
			     					<select name="class" id="class" style="width: 200px;" class="w3-input w3-border" required="true">
			...
			<div class="w3-row w3-section">
			  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-calendar"></i></div>
			    <div class="w3-rest">
			     					<select name="sem" id="sem" style="width: 200px;" class="w3-input w3-border" required="true">
