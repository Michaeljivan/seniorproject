...
<title>Register Advisor</title>
<!-- <link rel="stylesheet" href="style.css" type="text/css" /> -->
<link rel="stylesheet" type="text/css" href="main.css">
</head>  
<body>  
<div class="box">     
    <form method="post" action="process_register_advisor.php" name="registerform" id="registerform">
   <center>

    <h1>Advisor Registration Form</h1>
     
    <p>Please enter your details below to register as an Advisor.</p>
        <fieldset>
           ...
           <input class="form-control" type="text" name="phone" id="phone" maxlength="10" minlength="10" required="true" placeholder="1234567890" /><sup>Phone#</sup><br />
            ...
            <select name="role" id="role" class="form-control" required="true">
                <option value="Advisor" selected="true">Advisor</option>
