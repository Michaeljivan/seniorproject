<?php
	include "base.php";
	$sql = "SELECT * FROM users WHERE approved = '0' AND role = 'Advisor'";
...
<head>
	...
	<body>
		<h3>Here are Advisor Accounts, please approve:</h3><br>
			<form action="process_approve_advisors.php" method="post">
