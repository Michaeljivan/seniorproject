<?php
	include "base.php";
	$sql = "SELECT * FROM users WHERE approved = '0' AND role = 'Client'";
...
<head>
	...
	<body>
		<h3>Here are Client Accounts, please approve:</h3><br>
			<form action="process_approve_clients.php" method="post">
